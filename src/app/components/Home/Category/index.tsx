      ...
      <div className='container'>
        <div className='text-center'>
          ...
          <p className='text-lg font-normal max-w-md mx-auto my-6'>
            Comprehensive technology solutions for enterprise needs.
          </p>
        </div>
        {/* grid layout */}
        <div>
                  ...
                  <div
                    ...
                    <div className='relative group overflow-hidden w-full rounded-lg'>
                      ...
                      <Link href='/' target='_blank'>
                        <div className='absolute inset-0 bg-gradient-to-b from-darklight/0 from-60% to-darklight/80 lg:translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-in-out rounded-lg flex items-end'>
