...
export function Marquee({ children, speed = 32, className = '', reverse = false }: MarqueeProps) {
  ...
  // Isolate from page direction: translateX(-50%) only loops correctly in LTR.
  return (
    <div
      dir="ltr"
    ...
    >
      <div
        className={`marquee-track flex w-max items-center gap-12 pr-12 ${reverse ? 'marquee-reverse' : ''}`}
